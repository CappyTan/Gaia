...
// Archetype) at the start in the Roster picker. A hero's kit is the V3 choice-system kit they build
// from their picks (systems/classKit, ADR 0020) — `skills` starts empty and is derived by recalc.
...
// of any Attunement × Archetype in the Roster picker. Attunement only swaps the class identity
// (its 52-slot spec) and the affinity colour — the body/stat profile come from the archetype.
