...
export const ARCHETYPES: Record<string, Archetype> = {
  ...
  "Dual Swords": { role: "DPS", row: "front", spr: "⚔️", base: { hp: 44, mp: 14, atk: 14, spd: 11, armor: 2, mag: 5 }, growth: { hp: 6, mp: 2, atk: 3, spd: 1.1, armor: 0.4, mag: 0.6 } },
  "Two-Handed Sword": { role: "Breaker", row: "front", spr: "🗡️", base: { hp: 54, mp: 14, atk: 16, spd: 7, armor: 3, mag: 5 }, growth: { hp: 8, mp: 2, atk: 3.2, spd: 0.7, armor: 0.6, mag: 0.6 } },
  "Hammer": { role: "Breaker", row: "front", spr: "🔨", base: { hp: 58, mp: 12, atk: 17, spd: 5, armor: 5, mag: 3 }, growth: { hp: 9, mp: 1.6, atk: 3.2, spd: 0.5, armor: 0.9, mag: 0.4 } },
  "Dual Daggers": { role: "Rogue", row: "front", spr: "🗡", base: { hp: 40, mp: 14, atk: 13, spd: 13, armor: 1, mag: 5 }, growth: { hp: 5.5, mp: 2, atk: 2.8, spd: 1.2, armor: 0.3, mag: 0.6 } },
  "Dual Pistols": { role: "Gunner", row: "back", spr: "🔫", base: { hp: 42, mp: 16, atk: 13, spd: 11, armor: 1, mag: 6 }, growth: { hp: 6, mp: 2, atk: 2.8, spd: 1.0, armor: 0.3, mag: 0.8 } },
  "Rifle": { role: "Marksman", row: "back", spr: "🎯", base: { hp: 40, mp: 16, atk: 15, spd: 9, armor: 1, mag: 6 }, growth: { hp: 6, mp: 2, atk: 3.0, spd: 0.9, armor: 0.3, mag: 0.8 } },
  "Staff": { role: "Caster", row: "back", spr: "🔮", base: { hp: 36, mp: 30, atk: 6, spd: 8, armor: 1, mag: 13 }, growth: { hp: 5, mp: 5, atk: 1, spd: 0.8, armor: 0.3, mag: 2.2 } },
  "Spellblade": { role: "Hybrid", row: "front", spr: "✨", base: { hp: 48, mp: 22, atk: 11, spd: 9, armor: 3, mag: 10 }, growth: { hp: 7, mp: 3, atk: 2, spd: 0.9, armor: 0.6, mag: 1.4 } },
};
