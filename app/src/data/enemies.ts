...
export const ENEMIES: Record<string, EnemyDef> = {
  ...
  bandit: { name: "Highway Bandit", spr: "🗡️", att: "NOX", lvl: 1, hp: 40, atk: 11, spd: 8, armor: 1, mag: 0, xp: 30, gold: [6, 14], ai: "basic" },
  wolf: { name: "Gray Wolf", spr: "🐺", att: "ANIMA", lvl: 1, hp: 30, atk: 12, spd: 14, armor: 0, mag: 0, xp: 26, gold: [3, 8], ai: "basic" },
  cutpurse: { name: "Thieves' Cutpurse", spr: "🥷", att: "UMBRAXIS", lvl: 2, hp: 52, atk: 13, spd: 12, armor: 2, mag: 0, xp: 44, gold: [10, 22], ai: "evasive" },
  wisp: { name: "Forest Wisp", spr: "💠", att: "QUANTA", lvl: 2, hp: 34, atk: 9, spd: 13, armor: 0, mag: 12, xp: 42, gold: [6, 12], ai: "evasive", skills: ["hex"], castChance: 0.5 },
  marauder: { name: "Marauder", spr: "🪓", att: "ANIMA", lvl: 3, hp: 80, atk: 17, spd: 7, armor: 3, mag: 0, xp: 64, gold: [14, 26], ai: "basic" },
  lurker: { name: "Bog Lurker", spr: "🦎", att: "NOX", lvl: 3, hp: 88, atk: 15, spd: 6, armor: 4, mag: 0, xp: 68, gold: [12, 22], ai: "basic", onHit: { poison: 3 } },
  ...
  gloomwisp: { name: "Gloom Wisp", spr: "👁️", att: "QUANTA", lvl: 8, hp: 92, atk: 18, spd: 13, armor: 0, mag: 22, xp: 130, gold: [14, 26], ai: "evasive", skills: ["hex"], castChance: 0.5 },
  fenwitch: { name: "Fen Witch", spr: "🧙‍♀️", att: "ANIMA", lvl: 8, hp: 124, atk: 18, spd: 9, armor: 1, mag: 24, xp: 150, gold: [28, 46], ai: "caster", skills: ["mend"], castChance: 0.55 },
  knight: { name: "Sunken Knight", spr: "⚰️", att: "NOX", lvl: 8, hp: 205, atk: 36, spd: 6, armor: 6, mag: 0, xp: 150, gold: [24, 42], ai: "basic" },
  fenwarden: { name: "Fen Warden", spr: "🐲", att: "NOX", lvl: 9, hp: 1120, atk: 40, spd: 8, armor: 7, mag: 0, xp: 240, gold: [120, 200], ai: "boss", miniboss: true, skills: ["rally"], castChance: 0.4 },
  vorn: { name: "Mirelord Vorn", spr: "👹", att: "ANIMA", lvl: 10, hp: 2600, atk: 50, spd: 7, armor: 10, mag: 6, xp: 320, gold: [260, 400], ai: "boss", boss: true, skills: ["rally"], castChance: 0.35 },
};
