...
export const CHANGELOG: ChangeEntry[] = [
  { v: "v0.42", t: "Battle-screen layout pass — bigger battlefield, slimmer command/roster bar (70/30 split); hero bars sit flush at the bottom edge; heroes clustered closer together; names removed from the field sprites and the roster reordered (Auren · Sephi · Kaela · Liora · Rion); fresh Greenvale plains backdrop." },
