...
> review. Numberless by design. Mechanics vocabulary (summons, Entangle, Regen, Bloom, Evolve) draws
> on the [Attunement Mechanics Framework](../attunement-mechanics.md) — dev-approved, pending Dara.
...
- **Attunement signature:** **Infestation/Regen** + **Evolution**; defense via **summoned life, entangle, and healing**
...
allies to keep them breathing. It is the **summoner-protector**: a shield-bearer whose true shield is
an ecosystem. Where the other guardians soak, freeze, or dodge a blow, the Aegis ensures the blow
**lands on a beast, never connects through the thorns, or is healed away the instant it does.**
...
| **C · Symbiote** *(symbiosis)* | **Regenerative life** grafted onto allies — heal, Regen, link vitality | **VIT**, healing, links | off-healer / sustain | fragile party; long attrition fights |

**Build axes:** soak ↔ deny (A↔B) · self-summoning ↔ ally-grafting (A↔C) · bodies/control ↔ healing
...
- **C · Seedling** · buff · ally · *graft a healing seed: grants Regen* · gen **moderate ANIMA** · cd **short**

**@ MNA 25** *(A/C)*
- **A · Feral Bond** · buff · self · *your Guardian beast Evolves a stage: more HP and taunt* · gen **moderate ANIMA** · cd **medium**
- **C · Symbiosis** · buff · ally · *link to an ally: a share of damage they take is healed over time* · gen **moderate ANIMA** · cd **medium**
...
- **C · Verdant Tide** · heal · allAllies · *a wave of growth: small party heal + Regen* · gen **major ANIMA** · cd **medium**

**@ MNA 55** *(A/C)*
- **A · Beast Pack** · buff · self · *summon a second, lesser beast (numbers)* · gen **moderate ANIMA** · cd **medium**
- **C · Lifegraft** · heal · ally · *heal an ally and graft Regen that grows each turn (Bloom)* · gen **major ANIMA** · cd **medium**
...
- **C · Heartwood** · buff · allAllies · *plant a healing tree that pulses Regen to the party each turn* · gen **moderate ANIMA** · cd **long**

**@ MNA 85** *(A/C)*
- **A · Apex Evolve** · buff · self · *Evolve your Guardian to its apex form (huge body-blocker)* · gen **moderate ANIMA** · cd **long**
- **C · Bloomsurge** · heal · allAllies · *consume Bloom stacks for a burst heal* · gen **major ANIMA** · cd **medium**
...
- **C · Wellspring** · heal · allAllies · *a surge of vitality: heal the party + Regen* · cost **med ANIMA** · cd **medium**

**@ MNA 30** *(A/C)*
- **A · Pack Leader** · buff · self · *summon a pack of beasts at once (a wall of bodies)* · cost **med ANIMA** · cd **long**
- **C · Lifebond** · buff · allAllies · *link the whole party: damage to one is shared and healed over time* · cost **med ANIMA** · cd **long**
...
- **C · Rejuvenation** · heal · allAllies · *big party heal + a lasting Regen bloom* · cost **high ANIMA** · cd **long**

**@ MNA 60** *(A/C)*
- **A · Primal Evolution** · buff · self · *instantly Evolve all your summons to a higher form* · cost **high ANIMA** · cd **long**
- **C · Symbiotic Host** · buff · ally · *graft a symbiote that absorbs a share of an ally's damage and heals them* · cost **med ANIMA** · cd **medium**
...
- **C · Tree of Life** · heal · allAllies · *plant a great tree: powerful party Regen + revive a fallen ally* · cost **high ANIMA** · cd **long**
...
- **C · Communion** · heal · allAllies · *entwine the party's life: massive heal + shared Regen + cleanse* · cost **high ANIMA** · cd **long**
...
- **C · Eternal Bloom** *(Symbiote)* · allAllies · *the party becomes one organism: huge sustained Regen, shared life, and revive-on-death for the duration*
- **Genesis** *(neutral/fusion)* · all · *a burst of raw life — summon a Guardian, root all foes, and heal the party at once*
...
- **C · Greenheart** · *your Regen heals for more*
...
- **C · Worldtree** · *your healing summons pulse to the whole party and persist longer*
